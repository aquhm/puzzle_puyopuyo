...
//
//bool LocalPlayer::Initialize(float boardX, float boardY) 
//{
...
//}
//
//void LocalPlayer::HandleKeyboardInput(const SDL_Event& event) 
//{
//    if (game_core_->GetCurrentPhase() != GamePhase::Playing || !control_block_) 
//    {
//        return;
//    }
//
...
//}
//
//void LocalPlayer::HandleKeyboardState() 
//{
//    if (SDL_GetTicks() - last_input_time_ < 40) 
//    {
//        return;
//    }
//
...
//
//    if (game_core_->GetCurrentPhase() == GamePhase::Playing && control_block_ && control_block_->GetState() == BlockState::Playing) 
//    {
//
...
//        {
//            AddDropVelocity(10.0f);
//        }
//    }
//    else if (game_core_->GetCurrentPhase() == GamePhase::GameOver) 
//    {
...
//}
//
//bool LocalPlayer::MoveBlockLeft() 
//{
//    if (control_block_ && control_block_->GetState() == BlockState::Playing) 
//    {
...
//        {
//            NETWORK.MoveBlock(static_cast<uint8_t>(Constants::Direction::Left), 0);
//        }
//
//        return true;
//    }
...
//}
//
//bool LocalPlayer::MoveBlockRight() 
//{
//    if (control_block_ && control_block_->GetState() == BlockState::Playing) 
//    {
...
//        if (NETWORK.IsRunning()) 
//        {
//            NETWORK.MoveBlock(static_cast<uint8_t>(Constants::Direction::Right), 0);
//        }
//
//        return true;
//    }
...
//        if (NETWORK.IsRunning()) 
//        {
//            auto rotState = control_block_->GetRotateState();
//            NETWORK.RotateBlock(static_cast<uint8_t>(rotState), false);
//        }
//
//        return true;
//    }
...
//}
//
//bool LocalPlayer::AddDropVelocity(float velocity) 
//{
//    if (control_block_ && control_block_->GetState() == BlockState::Playing) 
//    {
//        if (control_block_->GetAddForceVelocityY() <= 70.0f) 
//        {
//            control_block_->ForceAddVelocityY(velocity);
//
//            if (NETWORK.IsRunning()) 
//            {
//                NETWORK.MoveBlock(static_cast<uint8_t>(Constants::Direction::Bottom), 0);
//            }
//
//            return true;
//        }
...
//{
//    if (!control_block_ || control_block_->GetState() != BlockState::Playing || !game_board_) 
//    {
//        return;
//    }
//
...
//                }
//
//                if (game_core_->GetBlockAt(xIdx, yIdx) == nullptr) 
//                {
...
void LocalPlayer::DestroyNextBlock()
{
