...
//}
//
//bool RemotePlayer::Initialize(float boardX, float boardY)
//{
//    if (!BasePlayer::Initialize(boardX, boardY)) 
//    {
//        return false;
//    }
//
...
//}
//
//void RemotePlayer::HandleMoveBlock(uint8_t moveType, float position) 
//{
...
//}
//
//void RemotePlayer::HandleRotateBlock(uint8_t rotateType, bool horizontalMoving) 
//{
//    if (!control_block_ || control_block_->GetState() != BlockState::Playing) 
//    {
//        return;
...
//}
//
//void RemotePlayer::HandleBlockState(uint8_t state) 
//{
//    if (control_block_) 
//    {
...
//}
//
//bool RemotePlayer::PushBlockInGame(std::span<float> pos1, std::span<float> pos2)
//{
//    if (!control_block_ || control_block_->GetState() != BlockState::Stationary || pos1.size() < 2 || pos2.size() < 2)
//    {
//        return false;
//    }
//
...
//        if (game_core_)
//        {
//            game_core_->SetBlockAt(x_idx_0, y_idx_0, blocks[0].get());
//            game_core_->SetBlockAt(x_idx_1, y_idx_1, blocks[1].get());
//            game_core_->UpdateLinkState(blocks[0].get());
//            game_core_->UpdateLinkState(blocks[1].get());
//        }
//
//        // 블록 목록 정렬
...
//
//        // 게임 상태 체크 (필요시)
//        if (!is_game_quit_ && game_core_)
//        {
//            game_core_->CheckGameBlockState(block_list_);
//        }
//
//        return true;
//    }
...
//}
//
//void RemotePlayer::RotateBlock(uint8_t rotate_type, bool horizontal_moving)
//{
//    if (!control_block_ || control_block_->GetState() != BlockState::Playing)
//    {
//        return;
...
//}
//
//void RemotePlayer::UpdateFallingBlock(uint8_t falling_idx, bool falling)
//{
//    if (control_block_ && control_block_->GetState() == BlockState::Playing)
//    {
...
//}
//
//void RemotePlayer::MoveBlock(uint8_t move_type, float position)
//{
//    if (!control_block_ || control_block_->GetState() != BlockState::Playing)
//    {
//        return;
...
//}
//
//bool RemotePlayer::Restart(const std::span<const uint8_t>& block_type1, const std::span<const uint8_t>& block_type2)
//{
//    // 플레이어 상태 리셋
//    Reset();
//
...
//    {
//        // 블록 초기화
//        InitializeNextBlocks(block_type1, block_type2);
//
//        // 게임 보드 초기화
//        if (game_board_)
//        {
...
//    {
//        SDL_Log("Failed to restart remote player: %s", e.what());
//        return false;
//    }
//}
//
//void RemotePlayer::InitializeNextBlocks(std::span<const uint8_t> block_type1, std::span<const uint8_t> block_type2)
//{
//    // 기존 블록 정리
//    next_blocks_.clear();
//
...
//
//    // 블록 추가
//    next_blocks_.push_back(std::move(next_block1));
//    next_blocks_.push_back(std::move(next_block2));
//
//    // 백그라운드에 블록 설정 (필요한 경우)
//    if (background_)
//    {
...
RemotePlayer::~RemotePlayer()
{
    // BasePlayer의 소멸자가 Release()를 호출하므로 추가 정리 작업은 필요 없음
}
